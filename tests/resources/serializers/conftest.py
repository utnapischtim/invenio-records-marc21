...
def marc21_metadata():
    ...
    return {
        ...
        "main_entry_personal_name": {
            ...
            "personal_name": "Philipp",
        },
        "complex_see_reference_subject": {
            "__order__": ["heading_referred_to"],
            "heading_referred_to": "TU Graz",
        },
        "dates_of_publication_and_or_sequential_designation": {
            "__order__": ["dates_of_publication_and_or_sequential_designation"],
            "dates_of_publication_and_or_sequential_designation": "2022",
        },
        "subject_added_entry_topical_term": [
            {
                "__order__": [
        ...
        "production_publication_distribution_manufacture_and_copyright_notice": [
            {
                ...
                "place_of_production_publication_distribution_manufacture": ["Tu Graz"],
                "date_of_production_publication_distribution_manufacture_or_copyright_notice": [
                    "2004"
                ],
            }
